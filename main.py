...
async def calculator(bot, message):
    ...
    x1=input
    await bot.send_message("Okay!, Give me the second number for your calculation.")
    x2=input
    await bot.send_message("Okay!, What operation do you want me to do?\nUse '+' for addition.\nUse '-' for substraction.\nUse '/' for division.\nUse '*' for multiplication.\nUse '%' for checking the reminder.")
    x3=input
    if x3 == '+':
        ans=x1+x2
        await bot.send_message("Your answer is "+str(ans))
    elif x3 == '-':
        ans=x1-x2
        await bot.send_message("Your answer is "+str(ans))
    elif x3 == '/':
        ...
        await bot.send_message("Please provide a valid operation.")
tgbot.run()
